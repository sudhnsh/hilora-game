...
import { 
    JourneyGameState, 
    LetterState,
    initializeJourneyGameState, 
    getWordFeedback, 
    isValidWord
} from '../utils/journeyGameUtils';
import Keyboard from './Keyboard';
import { useTheme } from '../context/ThemeContext';
import ThemeToggle from './ThemeToggle';
import JourneyInfoButton from './JourneyInfobutton';
...
const JourneyGame: React.FC<JourneyGameProps> = ({ onHomeClick, onBackClick, onPlayAgainClick }) => {
    const { theme } = useTheme();
    const [gameState, setJourneyGameState] = useState<JourneyGameState>(initializeJourneyGameState());
    ...
    const submitGuess = () => {
        ...
        const newState: JourneyGameState = {
            ...gameState,
        ...
        setJourneyGameState(newState);
        setCurrentGuess('');
    };

    const resetGame = () => {
        setJourneyGameState(initializeJourneyGameState());
        setCurrentGuess('');
        setAttempts(0);
        setMessage('');
        setIsShaking(false);
